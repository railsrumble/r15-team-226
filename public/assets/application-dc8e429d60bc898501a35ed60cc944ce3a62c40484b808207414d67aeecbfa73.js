    ...
    success: function(result) {
      ...
      $.each(doggies, function(index, object) {
        ...
        if (object.area) {
          ...
          image = {
            url: "/assets/dog-icon-ffb8f6e52de1afbf19d260986c2ebe4095fe6afb0ee05ed20d6147a54bcc3c92.png"//,
...
var cat_breeds = ["Abyssinian", "American Shorthair", "Birman", "Maine Coon", "Oriental", "Persian", "Ragdoll", "Siamese", "Sphynx", "Scottish Fold", "Cornish Rex", "Devon Rex", "Oriental", "Norwegian Forest Cat", "Burmese", "Siberian", "Tonkinese", "Russian Blue"] ;
  $('#pet_pet_type, #adoption_request_pet_attributes_pet_type').change(function(){
    switch ($('#pet_pet_type, #adoption_request_pet_attributes_pet_type').val()) {
      case 'dog':
        breeds = dog_breeds;
...
function add_options_to_breed_field(breeds){
  ...
  $.each(breeds, function(key, value) {
    $('#pet_breed, #adoption_request_pet_attributes_breed')

...
class DiscussionsControllerTest < ActionController::TestCase
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post :create, discussion: { breed: @discussion.breed, content: @discussion.content, discussion_type: @discussion.discussion_type, topic: @discussion.topic }
    end
  ...
  test "should update discussion" do
    patch :update, id: @discussion, discussion: { breed: @discussion.breed, content: @discussion.content, discussion_type: @discussion.discussion_type, topic: @discussion.topic }
    assert_redirected_to discussion_path(assigns(:discussion))
  end

...
Dragonfly::App.register_datastore(:s3forme){ Dragonfly::MyDataStore }
    ...
    def url_for(uid, opts={})
      if opts[:expires]
        ...
        host   = opts[:host]   || url_host || (
          bucket_name =~ SUBDOMAIN_PATTERN ? "#{bucket_name}.rest.s3for.me" : "rest.s3for.me/#{bucket_name}"
        )
